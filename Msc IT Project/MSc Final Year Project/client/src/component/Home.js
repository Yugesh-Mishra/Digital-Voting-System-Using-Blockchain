...
export default class Home extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      alert(
        `Failed to load web3, accounts, or smart contract. Check console for details.`
      );
      console.error(error);
    }
  };
  ...
  render() {
    if (!this.state.web3) {
      return (
        <>
          <Navbar />
          <center>Loading Web3, accounts, and smart contract...</center>
        </>
      );
    }
    return (
      <>
        ...
        <div className="container-item center-items info">
            <h2>Digital Voting System using Blockchain</h2>
          </div>
          <div className="container-item center-items info">
          ...
          {!this.state.elStarted & !this.state.elEnded ? (
            <div className="container-item info">
              <center>
                ...
                {this.state.isAdmin ? (
                  <p>Please set up the election.</p>
                ) : (
                  <p>Please wait..</p>
                )}
              </center>
        ...
        {this.state.isAdmin ? (<> <this.renderAdminHome /> </>) : this.state.elStarted ? ( <> <UserHome el={this.state.elDetails} /> </>) : !this.state.isElStarted && this.state.isElEnded ? (
          <>
                  ...
                  <div className="container-item center-items">
                    <div>
                      ...
                      <label className="label-home">
                        ...
                        <input
                          className="input-home"
                          placeholder="eg. yourmailID@examplemail.com"
                          name="adminEmail"
                          {...register("adminEmail", {
                            required: "*Required",
                            pattern: {
