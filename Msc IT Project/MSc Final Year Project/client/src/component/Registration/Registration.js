...
export default class Registration extends Component {
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      console.error(error);
      alert(
        `Failed to load web3, accounts, or smart contract. Check console for the details.`
      );
    }
  };
            ...
            <div className="container-main">
              ...
              <div className="container-item">
                <form>
                  ...
                  <div className="div-li">
                    <label className={"label-r"}>
                      NID Number <span style={{ color: "tomato" }}>*</span>
                      <input
                        className={"input-r"}
                        type="number"
                  ...
                  <p className="note">
                    ...
                    <br /> Make sure your account address and NID Number are
                    correct. <br /> Admin might not approve your account if the
                    provided NID Number does not matches the account
